...
public class Withdrawal extends Transaction
{
	...
	{
		//initializes super class variables
	...
	public void execute()
	{
		...
		do 
		{
			//obtain chosen amount to withdraw from the user
			...
			if (amount != CANCELED)
			{
				...
				{
					//check whether the cashDispenser has enough money
					...
					{
						screen.displayMessageLine("\nInsufficient cash avaialable in the ATM.\n\nPlease choose a smaller amount");
